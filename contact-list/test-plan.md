...
- edit contact happy path
- delete contact happy path

### V2

- field validation matrix
- direct URL protection checks
- API coverage
- API-assisted setup for UI tests

## Initial implementation order

1. smoke test for home page
2. login page object
3. sign-up page object
4. sign-up happy path
5. login negative path
6. login happy path
7. first logged-in contact flow
