...
// Edit contact
export const INVALID_EDIT_BIRTH_DATE =
  'Validation failed: birthdate: Birthdate is invalid';
export const INVALID_EDIT_EMAIL = 'Validation failed: email: Email is invalid';
export const INVALID_EDIT_PHONE =
  'Validation failed: phone: Phone number is invalid';
export const EDIT_EMPTY_PAYLOAD =
